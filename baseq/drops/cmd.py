...
@click.option('--top_million_reads', default=1000, help='Use the top X M reads')
...
@cli.command(short_help="Align the reads to genome")
...
def star_align(sample, bcdir, genome, aligndir):
    from baseq.drops.run_star import genrate_star_script
    print('[info] Split the cell barcodes ...')
